...
import info.androidhive.volleyexamples.model.JsonModel;
import info.androidhive.volleyexamples.volley.utils.Const;
import info.androidhive.volleyexamples.volley.utils.JacksonRequest;
...
public class JsonRequestActivity extends Activity implements OnClickListener {
	...
	public void makeJacksonReq() {
		showProgressDialog();
		JacksonRequest<JsonModel> req = new JacksonRequest<JsonModel>(Method.GET, JsonModel.class, Const.URL_JSON_OBJECT, new Listener<JsonModel>() {
